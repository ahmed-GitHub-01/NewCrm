...
Public Class FRM_ADD_USER
    ...
    Sub ADD_NEW_USER()
        ...
        CMD = New SqlCommand("INSERT INTO [dbo].[EMPLOYEE] (NAME,DATE_recruitment,PASS,PIC,DEPARTMENT,CODE,NUM,IS_VOKE,ACTIVEE,INTERNAL,SWITCH,NAME_EN)
             VALUES
           (@NAME,@DATE_recruitment,@PASS,@PIC,@DEPARTMENT,@CODE,@NUM,@IS_VOKE,@ACTIVEE,@INTERNAL,@SWITCH,@NAME_EN)", SQLCON_TELE)
